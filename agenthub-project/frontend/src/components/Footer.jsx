...
export default function Footer() {
    return (
        <footer className="bg-[#1a1f2e] border-t border-white/5 pt-16 pb-8 mt-auto text-gray-400">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    {/* Brand and Info */}
                    <div className="col-span-1 md:col-span-1">
                        <div className="flex items-center gap-2 mb-4">
                            <div className="size-8 rounded-lg flex items-center justify-center shadow-lg shadow-blue-500/20 overflow-hidden">
                                <img 
                                    src={logo}
                                    alt="AgentHub Logo" 
                            ...
                            <h2 className="text-xl font-bold tracking-tight text-white">AgentHub</h2>
                        </div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="#!" className="text-gray-500 hover:text-blue-400 transition-colors" aria-label="LinkedIn">
                                <i className="fa-brands fa-linkedin text-xl"></i>
                            </a>
                            <a href="#!" className="text-gray-500 hover:text-blue-400 transition-colors" aria-label="GitHub">
