            ...
            <main className="flex-1 max-w-7xl mx-auto px-6 py-12 w-full">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-16 bg-white dark:bg-[#1a2230] rounded-2xl border border-dashed border-slate-300 dark:border-slate-700">
                        ...
                        <p className="text-slate-500 mb-6">Sube tu primera inteligencia artificial al marketplace y empieza a generar ingresos.</p>
                        <Link to="/desarrollador/subir-agente" className="text-purple-600 font-bold hover:underline">Sube tu primer agente</Link>
                    </div>
                ) : (
                            ...
                            <div key={agente.id} className="bg-white dark:bg-[#1a2230] rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden hover:shadow-xl hover:border-purple-300 dark:hover:border-purple-500/50 transition-all flex flex-col">
                                ...
                                <div className="p-6 border-b border-slate-100 dark:border-slate-800">
                                    <div className="flex justify-between items-start mb-4">
                                        ...
                                        <span className={`px-3 py-1 text-xs font-bold rounded-full ${agente.estadoVerificacion === 'APROBADO' ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' : 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400'}`}>
